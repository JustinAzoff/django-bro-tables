...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TableEntry.timestamp'
        db.add_column(u'django_bro_tables_tableentry', 'timestamp',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TableEntry.timestamp'
        db.delete_column(u'django_bro_tables_tableentry', 'timestamp')
